...
--
-- Name: dab_feature_flags_aapflag; Type: TABLE; Schema: public; Owner: awx
--

CREATE TABLE public.dab_feature_flags_aapflag (
    id bigint NOT NULL,
    modified timestamp with time zone NOT NULL,
    created timestamp with time zone NOT NULL,
    name character varying(64) NOT NULL,
    ui_name character varying(64) NOT NULL,
    condition character varying(64) NOT NULL,
    value character varying(127) NOT NULL,
    required boolean NOT NULL,
    support_level character varying(25) NOT NULL,
    visibility boolean NOT NULL,
    toggle_type character varying(20) NOT NULL,
    description character varying(500) NOT NULL,
    support_url character varying(250) NOT NULL,
    labels jsonb,
    created_by_id integer,
    modified_by_id integer
);

ALTER TABLE public.dab_feature_flags_aapflag OWNER TO awx;

--
-- Name: dab_feature_flags_aapflag_id_seq; Type: SEQUENCE; Schema: public; Owner: awx
--

ALTER TABLE public.dab_feature_flags_aapflag ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.dab_feature_flags_aapflag_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dab_rbac_dabcontenttype; Type: TABLE; Schema: public; Owner: awx
--

CREATE TABLE public.dab_rbac_dabcontenttype (
    id bigint NOT NULL,
    service character varying(100) NOT NULL,
    app_label character varying(100) NOT NULL,
    model character varying(100) NOT NULL,
    parent_content_type_id bigint,
    api_slug character varying(201) NOT NULL,
    pk_field_type character varying(100) NOT NULL
);

ALTER TABLE public.dab_rbac_dabcontenttype OWNER TO awx;

--
-- Name: dab_rbac_dabcontenttype_id_seq; Type: SEQUENCE; Schema: public; Owner: awx
--

ALTER TABLE public.dab_rbac_dabcontenttype ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.dab_rbac_dabcontenttype_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.dab_rbac_roleevaluation (
    ...
    content_type_id integer NOT NULL,
    CONSTRAINT dab_rbac_roleevaluation_new_content_type_id_check CHECK ((content_type_id >= 0)),
...
CREATE TABLE public.dab_rbac_roleevaluationuuid (
    ...
    role_id bigint NOT NULL,
    content_type_id integer NOT NULL,
    CONSTRAINT dab_rbac_roleevaluationuuid_new_content_type_id_check CHECK ((content_type_id >= 0))
);
...
--
-- Name: main_eventquery; Type: TABLE; Schema: public; Owner: awx
--

CREATE TABLE public.main_eventquery (
    id integer NOT NULL,
    fqcn character varying(255) NOT NULL,
    collection_version character varying(32) NOT NULL,
    event_query jsonb NOT NULL
);

ALTER TABLE public.main_eventquery OWNER TO awx;

--
-- Name: main_eventquery_id_seq; Type: SEQUENCE; Schema: public; Owner: awx
--

ALTER TABLE public.main_eventquery ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.main_eventquery_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: main_indirectmanagednodeaudit; Type: TABLE; Schema: public; Owner: awx
--

CREATE TABLE public.main_indirectmanagednodeaudit (
    id integer NOT NULL,
    created timestamp with time zone NOT NULL,
    name character varying(255) NOT NULL,
    ...
    job_id integer NOT NULL,
    organization_id integer NOT NULL,
    CONSTRAINT main_indirectmanagednodeaudit_count_check CHECK ((count >= 0))
);

ALTER TABLE public.main_indirectmanagednodeaudit OWNER TO awx;

--
-- Name: main_indirectmanagednodeaudit_id_seq; Type: SEQUENCE; Schema: public; Owner: awx
--

ALTER TABLE public.main_indirectmanagednodeaudit ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.main_indirectmanagednodeaudit_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.main_inventory (
    ...
    opa_query_path character varying(128),
...
--
-- Name: main_inventorygroupvariableswithhistory; Type: TABLE; Schema: public; Owner: awx
--

CREATE TABLE public.main_inventorygroupvariableswithhistory (
    id integer NOT NULL,
...
ALTER TABLE public.main_inventorygroupvariableswithhistory OWNER TO awx;

--
-- Name: main_inventorygroupvariableswithhistory_id_seq; Type: SEQUENCE; Schema: public; Owner: awx
--

ALTER TABLE public.main_inventorygroupvariableswithhistory ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.main_inventorygroupvariableswithhistory_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dab_feature_flags_aapflag dab_feature_flags_aapflag_name_condition_793a67ed_uniq; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_feature_flags_aapflag
    ADD CONSTRAINT dab_feature_flags_aapflag_name_condition_793a67ed_uniq UNIQUE (name, condition);

--
-- Name: dab_feature_flags_aapflag dab_feature_flags_aapflag_pkey; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_feature_flags_aapflag
    ADD CONSTRAINT dab_feature_flags_aapflag_pkey PRIMARY KEY (id);

--
-- Name: dab_rbac_dabcontenttype dab_rbac_dabcontenttype_pkey; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_rbac_dabcontenttype
    ADD CONSTRAINT dab_rbac_dabcontenttype_pkey PRIMARY KEY (id);

--
-- Name: dab_rbac_dabcontenttype dab_rbac_dabcontenttype_service_model_5c525d51_uniq; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_rbac_dabcontenttype
    ADD CONSTRAINT dab_rbac_dabcontenttype_service_model_5c525d51_uniq UNIQUE (service, model);
...
--
-- Name: main_eventquery main_eventquery_fqcn_collection_version_604ae728_uniq; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_eventquery
    ADD CONSTRAINT main_eventquery_fqcn_collection_version_604ae728_uniq UNIQUE (fqcn, collection_version);

--
-- Name: main_eventquery main_eventquery_pkey; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_eventquery
    ADD CONSTRAINT main_eventquery_pkey PRIMARY KEY (id);
...
--
-- Name: main_indirectmanagednodeaudit main_indirectmanagednodeaudit_name_job_id_640ba8b1_uniq; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_indirectmanagednodeaudit
    ADD CONSTRAINT main_indirectmanagednodeaudit_name_job_id_640ba8b1_uniq UNIQUE (name, job_id);

--
-- Name: main_indirectmanagednodeaudit main_indirectmanagednodeaudit_pkey; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_indirectmanagednodeaudit
    ADD CONSTRAINT main_indirectmanagednodeaudit_pkey PRIMARY KEY (id);
...
--
-- Name: main_inventorygroupvariableswithhistory main_inventorygroupvariableswithhistory_pkey; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_inventorygroupvariableswithhistory
    ADD CONSTRAINT main_inventorygroupvariableswithhistory_pkey PRIMARY KEY (id);
...
--
-- Name: main_inventorygroupvariableswithhistory unique_inventory_group; Type: CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_inventorygroupvariableswithhistory
    ADD CONSTRAINT unique_inventory_group UNIQUE (inventory_id, group_id);
...
--
-- Name: dab_feature_flags_aapflag_created_by_id_e91ef57f; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_feature_flags_aapflag_created_by_id_e91ef57f ON public.dab_feature_flags_aapflag USING btree (created_by_id);

--
-- Name: dab_feature_flags_aapflag_modified_by_id_85ff050b; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_feature_flags_aapflag_modified_by_id_85ff050b ON public.dab_feature_flags_aapflag USING btree (modified_by_id);

--
-- Name: dab_rbac_dabcontenttype_parent_content_type_id_a04f1d4e; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_rbac_dabcontenttype_parent_content_type_id_a04f1d4e ON public.dab_rbac_dabcontenttype USING btree (parent_content_type_id);

--
-- Name: dab_rbac_dabpermission_new_content_type_id_997b17e2; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_rbac_dabpermission_new_content_type_id_997b17e2 ON public.dab_rbac_dabpermission USING btree (content_type_id);

--
-- Name: dab_rbac_objectrole_new_content_type_id_b571ead2; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_rbac_objectrole_new_content_type_id_b571ead2 ON public.dab_rbac_objectrole USING btree (content_type_id);

--
-- Name: dab_rbac_objectrole_parent_reference_7fff3507; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_rbac_objectrole_parent_reference_7fff3507 ON public.dab_rbac_objectrole USING btree (parent_reference);

--
-- Name: dab_rbac_objectrole_parent_reference_7fff3507_like; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_rbac_objectrole_parent_reference_7fff3507_like ON public.dab_rbac_objectrole USING btree (parent_reference text_pattern_ops);
...
--
-- Name: dab_rbac_roledefinition_new_content_type_id_b159b8e3; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_rbac_roledefinition_new_content_type_id_b159b8e3 ON public.dab_rbac_roledefinition USING btree (content_type_id);
...
--
-- Name: dab_rbac_roleteamassignment_new_content_type_id_5a504628; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_rbac_roleteamassignment_new_content_type_id_5a504628 ON public.dab_rbac_roleteamassignment USING btree (content_type_id);
...
--
-- Name: dab_rbac_roleuserassignment_new_content_type_id_490d7e3c; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX dab_rbac_roleuserassignment_new_content_type_id_490d7e3c ON public.dab_rbac_roleuserassignment USING btree (content_type_id);
...
--
-- Name: main_indirectmanagednodeaudit_host_id_5346b94b; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX main_indirectmanagednodeaudit_host_id_5346b94b ON public.main_indirectmanagednodeaudit USING btree (host_id);

--
-- Name: main_indirectmanagednodeaudit_inventory_id_0604f4f8; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX main_indirectmanagednodeaudit_inventory_id_0604f4f8 ON public.main_indirectmanagednodeaudit USING btree (inventory_id);

--
-- Name: main_indirectmanagednodeaudit_job_id_88885a93; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX main_indirectmanagednodeaudit_job_id_88885a93 ON public.main_indirectmanagednodeaudit USING btree (job_id);

--
-- Name: main_indirectmanagednodeaudit_organization_id_57a6a814; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX main_indirectmanagednodeaudit_organization_id_57a6a814 ON public.main_indirectmanagednodeaudit USING btree (organization_id);
...
--
-- Name: main_inventorygroupvariableswithhistory_group_id_e528905f; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX main_inventorygroupvariableswithhistory_group_id_e528905f ON public.main_inventorygroupvariableswithhistory USING btree (group_id);

--
-- Name: main_inventorygroupvariableswithhistory_inventory_id_0c92e9f2; Type: INDEX; Schema: public; Owner: awx
--

CREATE INDEX main_inventorygroupvariableswithhistory_inventory_id_0c92e9f2 ON public.main_inventorygroupvariableswithhistory USING btree (inventory_id);
...
--
-- Name: ujt_hard_name_constraint; Type: INDEX; Schema: public; Owner: awx
--
...
--
-- Name: dab_feature_flags_aapflag dab_feature_flags_aa_created_by_id_e91ef57f_fk_auth_user; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_feature_flags_aapflag
    ADD CONSTRAINT dab_feature_flags_aa_created_by_id_e91ef57f_fk_auth_user FOREIGN KEY (created_by_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;

--
-- Name: dab_feature_flags_aapflag dab_feature_flags_aa_modified_by_id_85ff050b_fk_auth_user; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_feature_flags_aapflag
    ADD CONSTRAINT dab_feature_flags_aa_modified_by_id_85ff050b_fk_auth_user FOREIGN KEY (modified_by_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;

--
-- Name: dab_rbac_dabcontenttype dab_rbac_dabcontentt_parent_content_type__a04f1d4e_fk_dab_rbac_; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_rbac_dabcontenttype
    ADD CONSTRAINT dab_rbac_dabcontentt_parent_content_type__a04f1d4e_fk_dab_rbac_ FOREIGN KEY (parent_content_type_id) REFERENCES public.dab_rbac_dabcontenttype(id) DEFERRABLE INITIALLY DEFERRED;

--
-- Name: dab_rbac_dabpermission dab_rbac_dabpermissi_content_type_id_2dbdb964_fk_dab_rbac_; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_rbac_dabpermission
    ADD CONSTRAINT dab_rbac_dabpermissi_content_type_id_2dbdb964_fk_dab_rbac_ FOREIGN KEY (content_type_id) REFERENCES public.dab_rbac_dabcontenttype(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: dab_rbac_objectrole dab_rbac_objectrole_content_type_id_a1bc92de_fk_dab_rbac_; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_rbac_objectrole
    ADD CONSTRAINT dab_rbac_objectrole_content_type_id_a1bc92de_fk_dab_rbac_ FOREIGN KEY (content_type_id) REFERENCES public.dab_rbac_dabcontenttype(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: dab_rbac_roledefinition dab_rbac_roledefinit_content_type_id_71c1ad50_fk_dab_rbac_; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_rbac_roledefinition
    ADD CONSTRAINT dab_rbac_roledefinit_content_type_id_71c1ad50_fk_dab_rbac_ FOREIGN KEY (content_type_id) REFERENCES public.dab_rbac_dabcontenttype(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: dab_rbac_roleteamassignment dab_rbac_roleteamass_content_type_id_adbc7356_fk_dab_rbac_; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_rbac_roleteamassignment
    ADD CONSTRAINT dab_rbac_roleteamass_content_type_id_adbc7356_fk_dab_rbac_ FOREIGN KEY (content_type_id) REFERENCES public.dab_rbac_dabcontenttype(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: dab_rbac_roleuserassignment dab_rbac_roleuserass_content_type_id_5e447f36_fk_dab_rbac_; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.dab_rbac_roleuserassignment
    ADD CONSTRAINT dab_rbac_roleuserass_content_type_id_5e447f36_fk_dab_rbac_ FOREIGN KEY (content_type_id) REFERENCES public.dab_rbac_dabcontenttype(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: main_indirectmanagednodeaudit main_indirectmanaged_inventory_id_0604f4f8_fk_main_inve; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_indirectmanagednodeaudit
    ADD CONSTRAINT main_indirectmanaged_inventory_id_0604f4f8_fk_main_inve FOREIGN KEY (inventory_id) REFERENCES public.main_inventory(id) DEFERRABLE INITIALLY DEFERRED;

--
-- Name: main_indirectmanagednodeaudit main_indirectmanaged_job_id_88885a93_fk_main_job_; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_indirectmanagednodeaudit
    ADD CONSTRAINT main_indirectmanaged_job_id_88885a93_fk_main_job_ FOREIGN KEY (job_id) REFERENCES public.main_job(unifiedjob_ptr_id) DEFERRABLE INITIALLY DEFERRED;

--
-- Name: main_indirectmanagednodeaudit main_indirectmanaged_organization_id_57a6a814_fk_main_orga; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_indirectmanagednodeaudit
    ADD CONSTRAINT main_indirectmanaged_organization_id_57a6a814_fk_main_orga FOREIGN KEY (organization_id) REFERENCES public.main_organization(id) DEFERRABLE INITIALLY DEFERRED;

--
-- Name: main_indirectmanagednodeaudit main_indirectmanagednodeaudit_host_id_5346b94b_fk_main_host_id; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_indirectmanagednodeaudit
    ADD CONSTRAINT main_indirectmanagednodeaudit_host_id_5346b94b_fk_main_host_id FOREIGN KEY (host_id) REFERENCES public.main_host(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: main_inventorygroupvariableswithhistory main_inventorygroupv_group_id_e528905f_fk_main_grou; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_inventorygroupvariableswithhistory
    ADD CONSTRAINT main_inventorygroupv_group_id_e528905f_fk_main_grou FOREIGN KEY (group_id) REFERENCES public.main_group(id) DEFERRABLE INITIALLY DEFERRED;

--
-- Name: main_inventorygroupvariableswithhistory main_inventorygroupv_inventory_id_0c92e9f2_fk_main_inve; Type: FK CONSTRAINT; Schema: public; Owner: awx
--

ALTER TABLE ONLY public.main_inventorygroupvariableswithhistory
    ADD CONSTRAINT main_inventorygroupv_inventory_id_0c92e9f2_fk_main_inve FOREIGN KEY (inventory_id) REFERENCES public.main_inventory(id) DEFERRABLE INITIALLY DEFERRED;
