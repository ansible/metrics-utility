...
8. Make sure *tests* pass:
   ...
   make test
   ```
   The compose environment is providing a postgres database for testing, and SeaweedFS for S3 target tests. If existing tests fail, fix the code. If new tests fail, fix the tests.
