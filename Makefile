...
help:
	@echo help sync test coverage lint fix compose compose-service compose-pytest-svc clean psql
...
.PHONY: help sync test coverage lint fix compose compose-service compose-pytest-svc clean psql
