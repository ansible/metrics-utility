...
@collector
def main_host_daily(*, db=None, since=None, until=None, output_dir=None, format='csv'):
    ...
    return copy_table(db=db, table='main_host_daily', query=query, prepend_query=True, output_dir=output_dir, format=format)
