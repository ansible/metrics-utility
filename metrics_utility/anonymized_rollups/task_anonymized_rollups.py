...
def task_anonymized_rollups(salt, year, month, day, ship_path, save_csv: bool = False):
    env_vars = {
    ...
    json_data = compute_anonymized_rollup_from_raw_data(salt, year, month, day, save_csv)
