...
class DataframeSummarizedByHost():
    ...
    def build_dataframe(self):
        ...
        ccsp_report["quantity_consumed"] = billing_data_monthly_rollup.index.nunique()
        ccsp_report['mark_x'] = ''
        ...
        ccsp_report = ccsp_report.reindex(columns=['mark_x',
                                                   'quantity_consumed',
                                                   'unit_price',
                                                   'extended_unit_price'])
    ...
    def cast_dataframe(self, df, types):
        ...
        if getattr(df.index, "levels", None) is None:
            # One column index
