...
def validate_inventory_scope(file_path):
    ...
    assert transform_sheet(sheet.to_dict()) == {
        0: {
            ...
            'canonical_facts': '{"ansible_machine_id": ["98cd2859149f4fe886b22dd44c7dea41", '
            ...
            'last_automation': Timestamp('2025-03-01 13:36:04.823000'),
        },
        1: {
            'Host name': 'manually_created_host_1',
            'Inventories': '["Test Inventory 1", "Test Inventory 2"]',
            'Organizations': '["Test Org 1", "Test Org 2"]',
            'canonical_facts': '{"ansible_machine_id": ["99cd2859149f4fe886b22dd44c7dea41", '
            ...
            'install_uuid': '4566f69f-4c03-4369-a97c-d0865e8fe9d2',
            'last_automation': Timestamp('2025-03-01 13:36:09.661000'),
        },
        2: {
            'Host name': 'real_host_4',
            'Inventories': '["Test Inventory 1", "Test Inventory 2"]',
