...
# since=None: daily_slicing should fall back to last_gathered_entries


def test_uses_last_gathered_entry_for_key():
...
def test_falls_back_to_horizon_when_no_entry():
    horizon = utcdt('2024-01-01')
...
def test_falls_back_to_horizon_when_entry_is_none():
    horizon = utcdt('2024-01-01')
    until = utcdt('2024-01-03')
...
def test_clamps_to_horizon_when_entry_is_older():
...
def test_handles_stale_non_datetime_entry():
    horizon = utcdt('2024-01-01')
    until = utcdt('2024-01-03')
...
def test_ignores_entries_for_other_keys():
    horizon = utcdt('2024-01-01')
...
def test_defaults_to_empty_when_no_entries_kwarg():
    horizon = utcdt('2024-01-01')
    until = utcdt('2024-01-03')
...
# since provided: daily_slicing should use it directly


def test_uses_explicit_since():
    horizon = utcdt('2024-01-01')
...
def test_ignores_last_gathered_entries_when_since_given():
    horizon = utcdt('2024-01-01')
