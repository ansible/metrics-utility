...
@register('csv_no_slicing_1-2x', '1.0', format='csv')
...
@register('csv_no_slicing_2-1x', '1.0', format='csv')
...
@register('csv_no_slicing_3-10x', '1.0', format='csv')
...
@register('csv_no_slicing_4-12x', '1.0', format='csv')
