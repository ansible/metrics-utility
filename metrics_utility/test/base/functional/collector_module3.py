...
def csv_no_slicing1(**kwargs):
    return simple_csv('csv_no_slicing_1-2x', 2)
...
def csv_with_slicing1a(**kwargs):
    return simple_csv('csv_with_slicing_1-5x', 2)
...
def csv_with_slicing1b(**kwargs):
    return simple_csv('csv_with_slicing_1-5x', 3)


@register('csv_no_slicing_2-1x', '1.0', format='csv', description='CSV No slicing 2')
def csv_no_slicing2(**kwargs):
    return simple_csv('csv_no_slicing_2-1x', 1)
...
def csv_with_slicing2a(**kwargs):
    return simple_csv('csv_with_slicing_2-3x', 2)


@register('csv_no_slicing_3-10x', '1.0', format='csv', description='CSV No slicing 3')
def csv_no_slicing3(**kwargs):
    return simple_csv('csv_no_slicing_3-10x', 10)
...
def csv_with_slicing3(**kwargs):
    return simple_csv('csv_with_slicing_3-2x', 2)


@register('csv_no_slicing_4-12x', '1.0', format='csv', description='CSV No slicing 3')
def csv_no_slicing4(**kwargs):
    return simple_csv('csv_no_slicing_4-12x', 12)
...
def csv_with_slicing2b(**kwargs):
    return simple_csv('csv_with_slicing_2-3x', 1)
...
def csv_with_slicing4(**kwargs):
    return simple_csv('csv_with_slicing_4-3x', 3)
