...
events = [
    # ansible.builtin.copy
    {
        ...
        'job_created': datetime(2024, 1, 1, 0, 0, 0), 'job_started': datetime(2024, 1, 1, 0, 1, 0), 'job_finished': datetime(2024, 1, 1, 0, 10, 0),
        'job_failed': False,
    ...
    {
        'job_id': 2, 'playbook': 'db.yml', 'host_id': 1, 'task_uuid': 't003',
        'event': 'runner_on_ok', 'task_action': 'ansible.builtin.copy',
        'job_created': datetime(2024, 1, 2, 12, 0, 0), 'job_started': datetime(2024, 1, 2, 12, 5, 0), 'job_finished': datetime(2024, 1, 2, 12, 30, 0),
        'job_failed': False,
        'resolved_action': None,
    },
    {
        'job_id': 2, 'playbook': 'db.yml', 'host_id': 2, 'task_uuid': 't004',
        'event': 'runner_on_ok', 'task_action': 'ansible.builtin.copy',
        'job_created': datetime(2024, 1, 2, 12, 0, 0), 'job_started': datetime(2024, 1, 2, 12, 5, 0), 'job_finished': datetime(2024, 1, 2, 12, 30, 0),
        'job_failed': False,
        'resolved_action': None,
    ...
    {
        'job_id': 1, 'playbook': 'site.yml', 'host_id': 3, 'task_uuid': 't014',
        'event': 'runner_on_ok', 'task_action': 'ansible.builtin.copy',
        'job_created': datetime(2024, 1, 1, 0, 0, 0), 'job_started': datetime(2024, 1, 1, 0, 1, 0), 'job_finished': datetime(2024, 1, 1, 0, 10, 0),
        'job_failed': False,
        'resolved_action': None,
    ...
    {
        'job_id': 2, 'playbook': 'db.yml', 'host_id': 4, 'task_uuid': 't015',
        'event': 'runner_on_ok', 'task_action': 'ansible.builtin.copy',
        'job_created': datetime(2024, 1, 2, 12, 0, 0), 'job_started': datetime(2024, 1, 2, 12, 5, 0), 'job_finished': datetime(2024, 1, 2, 12, 30, 0),
        'job_failed': False,
        'resolved_action': None,
    ...
    {
        'job_id': 1, 'playbook': 'site.yml', 'host_id': 1, 'task_uuid': 't005',
    ...
    {
        'job_id': 1, 'playbook': 'site.yml', 'host_id': 2, 'task_uuid': 't006',
        'event': 'runner_on_failed', 'task_action': 'community.general.yum',
        'job_created': datetime(2024, 1, 1, 0, 0, 0), 'job_started': datetime(2024, 1, 1, 0, 1, 0), 'job_finished': datetime(2024, 1, 1, 0, 10, 0),
        'job_failed': False,
        'resolved_action': None,
    ...
    {
        'job_id': 2, 'playbook': 'db.yml', 'host_id': 1, 'task_uuid': 't007',
    ...
    {
        'job_id': 1, 'playbook': 'site.yml', 'host_id': 2, 'task_uuid': 't008',
        'event': 'runner_on_async_ok', 'task_action': 'community.mongodb.insert',
        'job_created': datetime(2024, 1, 1, 0, 0, 0), 'job_started': datetime(2024, 1, 1, 0, 1, 0), 'job_finished': datetime(2024, 1, 1, 0, 10, 0),
        'job_failed': False,
        'resolved_action': None,
    },
    {
        'job_id': 2, 'playbook': 'db.yml', 'host_id': 1, 'task_uuid': 't009',
        'event': 'runner_on_failed', 'task_action': 'community.mongodb.insert',
        'job_created': datetime(2024, 1, 2, 12, 0, 0), 'job_started': datetime(2024, 1, 2, 12, 5, 0), 'job_finished': datetime(2024, 1, 2, 12, 30, 0),
        'job_failed': True,
        'resolved_action': None,
    },
...
def test_events_modules_aggregations_basic():
    ...
    assert result['avg_number_of_modules_used_in_a_playbook'] == 3
