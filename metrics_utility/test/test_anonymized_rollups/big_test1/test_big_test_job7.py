...
def test_big_test7():
    ...
    try:
        ...
        assert controller_version_data['controller_version'] == '2.18.0', 'controller_version should be "2.18.0"'
        assert controller_version_data['job_type_total'] == 1, f'Should have 1 job type, got {controller_version_data["job_type_total"]}'
        assert controller_version_data['launch_type_workflow_total'] == 1, (
            f'Should have 1 workflow launch type, got {controller_version_data.get("launch_type_workflow_total", 0)}'
        )
        ...
        assert 'Amazon Web Services' in statistics['rollup_period_credential_types']
