...
def test_big_test7():
    ...
    try:
        ...
        assert ansible_version_data['launch_type_workflow_total'] == 1, (
            f'Should have 1 workflow launch type, got {ansible_version_data.get("launch_type_workflow_total", 0)}'
        )
