...
#
# Host2:
#   - Task 1 (ansible.builtin.copy): failed (1st attempt) -> failed (2nd attempt) -> ok (retry successful on 3rd attempt)
#   - Task 2 (ansible.builtin.file): ok
#   - Task 3 (ansible.builtin.yum): ok
...
#   - Failed hosts: 0
#   - Unreachable hosts: 0
#   - Total task runs: 15 (3 tasks × 4 hosts + 2 retries for Host2, 1 retry for Host3, 1 retry for Host4)
#   - Successful task runs: 12 (all tasks eventually succeeded)
#   - Failed task runs: 4 (Host2 Task 1 initial 2 attempts, Host3 Task 2 initial, Host4 Task 3 initial)
#   - Dark task runs: 0
...
jobs = [
    {
        'id': 8,
        'started': '2024-01-15 17:00:00.000000+00',
        'finished': '2024-01-15 17:06:30.000000+00',  # 6.5 minutes
        ...
        'created': '2024-01-15 16:59:30.000000+00',  # 30s wait
        'model': 'job',
        ...
        'execution_environment_id': 6,  # EE for ansible.builtin 2.19.0 only
    },
]

# Job host summary dataset - aligned with events
# Job 8: 4 hosts, all successful
# Host1: 3 ok tasks (successful)
# Host2: 3 ok tasks (successful, Task 1 retried twice)
# Host3: 3 ok tasks (successful, Task 2 retried)
# Host4: 3 ok tasks (successful, Task 3 retried)
jobhostsummary = [
    # Job 8 - Host1 (3 ok tasks)
    {
        'dark': 0,
        'failures': 0,
        'ok': 3,
    ...
    # Job 8 - Host2 (3 ok tasks, Task 1 retried twice but eventually succeeded)
    {
        'dark': 0,
        'failures': 0,
        'ok': 3,
    ...
    # Job 8 - Host3 (3 ok tasks, Task 2 retried but eventually succeeded)
    {
        'dark': 0,
        'failures': 0,
        'ok': 3,
    ...
    # Job 8 - Host4 (3 ok tasks, Task 3 retried but eventually succeeded)
    {
        'dark': 0,
        'failures': 0,
        'ok': 3,
...
events = [
    # ================================================================
    # Job 8 - T1 - playbook1.yml - 4 hosts, all succeed
    # ================================================================
    ...
    },
    {
        ...
        'job_created': '2024-01-15 16:59:30+00',
        'job_started': '2024-01-15 17:00:00+00',
        'job_finished': '2024-01-15 17:06:30+00',
        'job_failed': False,
    ...
    # Host2 - Task 1 failed (1st attempt) -> failed (2nd attempt) -> ok (retry successful on 3rd attempt), Task 2 ok, Task 3 ok
    {
        'job_id': 8,
        'playbook': 'playbook1.yml',
        'host_id': 2,
