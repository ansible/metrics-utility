...
def test_big_test8():
    ...
    try:
        ...
        assert ansible_version_data['launch_type_callback_total'] == 1, f'Should have 1 callback launch type, got {ansible_version_data.get("launch_type_callback_total", 0)}'
